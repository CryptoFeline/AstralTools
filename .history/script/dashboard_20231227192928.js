...
function updateDashboard(balance) {
    ...
    // Assuming the token balance is in a smaller unit (like wei), convert it to the main unit (like ether)
    // Replace 18 with the actual decimal places of your token
    const adjustedBalance = tokenBalance / Math.pow(10, 18);
